...
{
    public partial class $fileinputname$New : ContentItemNew<$fileinputname$View>
    {
        ...
        /// </summary>
        /// <value></value>
        [EmbeddedTemplateAttribute($fileinputname$New.layoutTemplateName, "$fileinputname$_New_Template_Desc", "/$fileinputname$", false, "2009-04-10")]
        ...
        protected override string LayoutTemplateName
        {
            get
            {
                return $fileinputname$New.layoutTemplateName;
            }
        }

        private const string layoutTemplateName =
            "$rootnamespace$.$fileinputname$.ViewControls.New.ascx";
