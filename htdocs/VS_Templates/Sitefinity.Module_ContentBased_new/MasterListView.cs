...
namespace ProjectsModule.Web.UI.Public
{
	public class MasterListView : ViewBase
	{
		...
		public override string LayoutTemplatePath
		{
			get
			{
				var path = "~/Projects/" + layoutTemplateName;
				return path;
			}
			set
			{
		...
		/// <summary>
		/// Gets the repeater for Project Items list.
		/// </summary>
		/// <value>The repeater.</value>
		protected internal virtual RadListView ProjectsListControl
		{
			get
			{
				return this.Container.GetControl<RadListView>("ProjectsList", true);
			}
		}
		...
		internal const string layoutTemplateName = "ProjectsModule.Web.UI.Public.Resources.MasterListView.ascx";
	}
}
