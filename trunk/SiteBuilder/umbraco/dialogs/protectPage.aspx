...
<asp:Content ContentPlaceHolderID="body" runat="server">
        ...
        <asp:Panel ID="p_mode" runat="server">
          ...
          <p>
             <asp:Button ID="bt_selectMode" runat="server" Text="select" OnClick="selectMode" />&nbsp; <em><%= umbraco.ui.Text("or") %></em>&nbsp; <a href="#" style="color: blue" onclick="top.closeModal()"><%=umbraco.ui.Text("cancel")%></a>
          </p>
         </asp:Panel>
