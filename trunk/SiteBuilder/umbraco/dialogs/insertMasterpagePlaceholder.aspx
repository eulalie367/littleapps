...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
  ...
  <p>
    <input type="button" onclick="insertCode(); return false;" value="<%= umbraco.ui.Text("insert") %>" /> <em><%= umbraco.ui.Text("or") %></em> <a href="#" onclick="top.closeModal(); return false;"><%= umbraco.ui.Text("cancel") %></a>
  </p>
