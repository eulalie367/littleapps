<%@ Page Language="c#" CodeBehind="moveOrCopy.aspx.cs" MasterPageFile="../masterpages/umbracoDialog.Master"
    AutoEventWireup="True" Inherits="umbraco.dialogs.moveOrCopy" %>
...
<asp:Content ContentPlaceHolderID="body" runat="server">
    ...
    <cc1:Pane ID="pane_form" runat="server" Visible="false">
        <cc1:PropertyPanel runat="server">
            <iframe src="../TreeInit.aspx?app=<%=umbraco.helper.Request("app")%>&isDialog=true&dialogMode=id&contextMenu=false"
