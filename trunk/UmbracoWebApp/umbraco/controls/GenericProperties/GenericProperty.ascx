...
<li id="<%=this.FullId%>" onMouseDown="activeDragId = this.id;">
	<div class="propertyForm" id="<%=this.FullId%>_form">
			...
			<!--
			<a href="#" onclick="top.openModal('dialogs/propertyEditor.aspx?propertyId=<%= this.Id %>&docTypeId=<%= Request.QueryString["id"] %>', 'Edit the property <%= this.Name %>', 500, 600); return false;">Edit</a>
			-->
