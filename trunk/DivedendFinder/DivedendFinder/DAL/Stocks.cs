...
namespace StockMarket
{
    ...
    partial void InsertHistoricalQuote(HistoricalQuote instance);
    partial void UpdateHistoricalQuote(HistoricalQuote instance);
    partial void DeleteHistoricalQuote(HistoricalQuote instance);
	...
	public partial class HistoricalQuote : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _StockQuoteID;
		
		private string _Ticker;
		
		private bool _IsAfterClose;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnStockQuoteIDChanging(int value);
    partial void OnStockQuoteIDChanged();
    partial void OnTickerChanging(string value);
    partial void OnTickerChanged();
    partial void OnIsAfterCloseChanging(bool value);
    partial void OnIsAfterCloseChanged();
    ...
    partial void OnPriceChangeChanging(System.Nullable<double> value);
    ...
    partial void OnCreatedTimeChanged();
		...
		[Column(Storage="_StockQuoteID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int StockQuoteID
		{
			get
			{
				return this._StockQuoteID;
			}
			set
			{
				if ((this._StockQuoteID != value))
				{
					this.OnStockQuoteIDChanging(value);
					this.SendPropertyChanging();
					this._StockQuoteID = value;
					this.SendPropertyChanged("StockQuoteID");
					this.OnStockQuoteIDChanged();
				}
			}
		}
		...
		[Column(Name="isAfterClose", Storage="_IsAfterClose", DbType="Bit NOT NULL")]
		public bool IsAfterClose
		{
			get
			{
				return this._IsAfterClose;
			}
			set
			{
				if ((this._IsAfterClose != value))
				{
					this.OnIsAfterCloseChanging(value);
					this.SendPropertyChanging();
					this._IsAfterClose = value;
					this.SendPropertyChanged("IsAfterClose");
					this.OnIsAfterCloseChanged();
				}
			}
		}
