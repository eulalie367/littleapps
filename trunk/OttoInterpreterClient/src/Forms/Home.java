...
import Agent.*;
    //</editor-fold>
public class Home extends Form implements CommandListener
{
...
//</editor-fold>
    ...
    {
        this.confirm = new Command("Login", Command.OK, 0);
    ...
    {
            display().setCurrent(new Main(this.parent));
    }
